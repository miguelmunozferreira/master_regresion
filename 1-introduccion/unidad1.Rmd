...
Con los datos de los buitres leonados
...
Dibujar la nube de puntos con la instrucción plot() y añadir la recta de regresión con la instrucción abline()
...
Dibujar el gráfico de residuos vs. valores ajustados con la función plot() aplicada al objeto
lm
...
Añadir al gráfico de dispersión del apartado (a) la curva de regresión parabólica
...
Con los datos de la tensión arterial sistólica y la edad de los 69 pacientes calcular los coeficientes de regresión de la recta mínimo cuadrática.
...
Calcular la capacidad de la carretera o punto de máximo flujo. Recordar que flujo = vel × densidad
